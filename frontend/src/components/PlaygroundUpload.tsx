  ...
  return (
    <div className="max-w-md mx-auto p-6 space-y-6">
      <div className="text-center">
        <h1 className="text-2xl font-semibold mb-2">Evaluate Setup</h1>
        <p className="text-muted-foreground">Add a picture of your environment - cover as much of the classroom as possible</p>
      </div>
